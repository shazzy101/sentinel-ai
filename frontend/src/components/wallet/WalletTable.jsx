...
function HeaderRow() {
  return (
    <div className="grid grid-cols-[28px_minmax(0,1fr)_80px_100px_120px_130px_90px_70px] px-5 py-3 bg-bg-surface border-b border-border-subtle text-[10px] uppercase tracking-[1.2px] text-text-muted">
      <div>#</div>
      <div>Wallet</div>
      <div>Chain</div>
      <div>Score</div>
  ...
  return (
    <div className="p-5">
      ...
      {Array.from({ length: 8 }).map((_, idx) => (
        <div key={idx} className="grid grid-cols-[28px_minmax(0,1fr)_80px_100px_120px_130px_90px_70px] items-center py-3.5 border-b border-border-subtle">
