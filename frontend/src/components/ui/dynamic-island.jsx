...
const DynamicIslandContent = ({
  ...
  return (
    <motion.div
      id={id}
      className="mx-auto h-0 w-0 items-center justify-center border border-border-default bg-bg-elevated text-text-primary transition duration-300 ease-in-out focus-within:bg-bg-overlay hover:shadow-lg hover:shadow-green/5"
      animate={{
